...
execute as @a store result score @s rs.player.x run data get entity @s Pos[0]
execute as @a store result score @s rs.player.y run data get entity @s Pos[1]
execute as @a store result score @s rs.player.z run data get entity @s Pos[2]

#loop the region list
tag @a remove rs.in_a_region
