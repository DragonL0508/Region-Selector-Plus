#usage :
#function rs_cmd:set_leavecmd {id:"<ID>",cmd:"<Command>"}
...
$data modify storage rs:data region_$(id).leave_cmd set value "$(cmd)"

$tellraw @s {"text": "\n§7[§a!§7] §aThe leave command of §e$(id) §ahas been set to:\n  §7§o- §f§o$(cmd)\n"}
