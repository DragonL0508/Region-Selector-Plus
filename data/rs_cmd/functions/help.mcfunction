...
tellraw @s {"text": "§7§o- Set the command to be executed when the player enters a specific area"}

tellraw @s {"text": "\n§a/function rs_cmd:set_leavecmd §b{id:\"<ID>\", cmd:\"<Command>\"}"}
tellraw @s {"text": "§7§o- Set the command to be executed when the player leaves a specific area"}

tellraw @s {"text": "\n§a/function rs_cmd:toggle_actionbar"}
tellraw @s {"text": "§7§o- Used to decide whether to display area information in the actionbar"}